...
internal class KotestBasicExample : BehaviorSpec(
    {
        Given("닉네임이 설정되어 있지 않을 때") {
            ...
            NICKNAME_MATCH_MAP.forAll { (originalNickname, renameNickname) ->
        ...
        Given("닉네임이 설정되어 있을 때") {
            ...
            NICKNAME_CONTAIN_MAP.forAll { (originalNickname, containNickname) ->
                When("닉네임을 '$originalNickname' 로 설정하면") {
                    nickname = originalNickname
    ...
    companion object {
        private val NICKNAME_MATCH_MAP = listOf(
            "Bell" to "Bell",
            "Soft Bell" to "Soft Bell",
            "Hard Bell" to "Hard Bell",
        )
        private val NICKNAME_CONTAIN_MAP = listOf(
            "Bell" to "Bell",
            "Soft Bell" to "Bell",
            "Hard Bell" to "Bell",
        )
